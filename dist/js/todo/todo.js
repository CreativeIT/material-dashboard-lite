        ...
        var View = (function () {
            ...
            _createClass(View, [{
                ...
                value: function insertInput() {
                    ...
                    var inputSpan = document.querySelector('.todo  .list li:last-child .mdl-checkbox__label');
                ...
                key: '_prepareTemplateSingleLine',
                value: function _prepareTemplateSingleLine(data) {
                ...
                value: function showAll(database) {
                    ...
                    database.forEach(function (data) {
                        ...
                        if (data.id == '01.01.16') {
                            /*For example*/
                            newLi.innerHTML = _this._prepareTemplateSingleLine(data); /*used template only for one item(with id = '01.01.16')*/
                        } else {
        ...
        var Controller = (function () {
            function Controller(model, view) {
                ...
                this.$addItemButton.addEventListener('click', function () {
                    ...
                    var inputTextArea = document.querySelector('.todo .list__item:last-child .mdl-textfield__input');
