...
//        disableDefaultUI: true,
        ...
        let map = new google.maps.Map(document.querySelector('.map__window'), map_options);
        let markerImage = 'images/marker.png';
        let activeMarkerImage = 'images/active_marker.png';
        let markers = {
            theatre: {
...
console.log(markers.theatre.marker);
...
//                map.panTo(markers.theatre.getPosition());
//            }, 3000);
//        });
